...
router.post("/",(req,res)=>{
    if(req.body.email){
      ...
      res.send("the user with firstname "+ (req.body.firstName) +" has been added successfully.");//This line is to be replaced with actual return value
});
...
router.put("/:email", (req, res) => {
   ...
   if(friend){
    ...
    res.send ("The friend with "+ email+ " has been updated successfully"); 
   }else{
